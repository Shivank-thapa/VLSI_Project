...
$(ObjDir)/digit_recognition.cpp_pre.cpp.tb.o : digit_recognition.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling digit_recognition.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/check_result.cpp_pre.cpp.tb.o : check_result.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling check_result.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/digitrec.cpp_pre.cpp.tb.o : digitrec.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling digitrec.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
