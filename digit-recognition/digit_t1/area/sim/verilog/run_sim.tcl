...
set ap_argv "-p ./196data/100_training.dat -t ./196data/test_set.dat -l ./196data/expected.dat"
...
set ret [catch {eval exec ./cosim.tv.exe -p ./196data/100_training.dat -t ./196data/test_set.dat -l ./196data/expected.dat | tee temp0.log >&@ stdout} err]
...
if {[file isfile DigitRec.autotvin.dat]} {
	file delete -force DigitRec.autotvin.dat
}

if {[file isfile DigitRec.autotvout.dat]} {
	file delete -force DigitRec.autotvout.dat
}
...
set ret [catch {eval exec ./cosim.pc.exe -p ./196data/100_training.dat -t ./196data/test_set.dat -l ./196data/expected.dat | tee temp0.log >&@ stdout} err]
