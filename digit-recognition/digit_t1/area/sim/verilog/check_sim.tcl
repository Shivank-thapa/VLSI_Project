...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.DigitRec.autotvin_array4.dat"
         "c.DigitRec.autotvin_global_results.dat"
         "c.DigitRec.autotvin_num_training.dat"
         "c.DigitRec.autotvin_num_test.dat"
         "c.DigitRec.autotvout_global_results.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.DigitRec.autotvout_global_results.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
