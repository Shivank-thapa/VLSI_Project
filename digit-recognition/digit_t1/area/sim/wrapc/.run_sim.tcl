...
proc run_exec {fileExe} {
	...
	set ret [catch {eval exec "./$fileExe -p ./196data/100_training.dat -t ./196data/test_set.dat -l ./196data/expected.dat | tee tmp.log" >&@ stdout} err]
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "DigitRec.autotvin.dat"
	set constFileTvOut       "DigitRec.autotvout.dat"
	set constFileHdlTvIn     "DigitRec.autohdltvin.dat"
	set constFileHdlTvOut    "DigitRec.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
