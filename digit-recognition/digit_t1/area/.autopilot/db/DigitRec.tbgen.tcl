...
set C_modelArgList {
	{ array4 int 256 regular {array 20000 { 1 3 } 1 1 }  }
	{ global_results int 8 regular {array 2000 { 0 3 } 0 1 }  }
	{ num_training int 32 regular  }
	{ num_test int 32 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "array4", "interface" : "memory", "bitwidth" : 256, "direction" : "READONLY", "bitSlice":[{"low":0,"up":255,"cElement": [{"cName": "global_training_set.V","cData": "uint256","bit_use": { "low": 0,"up": 255},"cArray": [{"low" : 0,"up" : 17999,"step" : 1}]},{"cName": "global_test_set.V","cData": "uint256","bit_use": { "low": 0,"up": 255},"cArray": [{"low" : 0,"up" : 1999,"step" : 1}]}]}]} , 
...
set portList { 
	...
	{ array4_address0 sc_out sc_lv 15 signal 0 } 
	{ array4_ce0 sc_out sc_logic 1 signal 0 } 
	{ array4_q0 sc_in sc_lv 256 signal 0 } 
	{ global_results_address0 sc_out sc_lv 11 signal 1 } 
	{ global_results_ce0 sc_out sc_logic 1 signal 1 } 
	{ global_results_we0 sc_out sc_logic 1 signal 1 } 
	{ global_results_d0 sc_out sc_lv 8 signal 1 } 
	{ num_training sc_in sc_lv 32 signal 2 } 
	{ num_test sc_in sc_lv 32 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "array4_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "array4", "role": "address0" }} , 
 	{ "name": "array4_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "array4", "role": "ce0" }} , 
 	{ "name": "array4_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":256, "type": "signal", "bundle":{"name": "array4", "role": "q0" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "36004", "EstimateLatencyMax" : "9584410004",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"Port" : [
			{"Name" : "array4", "Type" : "Memory", "Direction" : "I"},
	...
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.array3_U", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.knn_set_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	DigitRec {
		array4 {Type I LastRead 2 FirstWrite -1}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "36004", "Max" : "9584410004"}
	, {"Name" : "Interval", "Min" : "36005", "Max" : "994475413"}
]}
...
set Spec2ImplPortList { 
	array4 { ap_memory {  { array4_address0 mem_address 1 15 }  { array4_ce0 mem_ce 1 1 }  { array4_q0 mem_dout 0 256 } } }
