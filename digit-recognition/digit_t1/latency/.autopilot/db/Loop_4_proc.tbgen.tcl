...
set C_modelArgList {
	...
	{ results int 4 regular {array 2000 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "num_test", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "results", "interface" : "memory", "bitwidth" : 4, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ results_q0 sc_in sc_lv 4 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "results_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "results", "role": "q0" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "results", "Type" : "Memory", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0"}]}]}
...
set Spec2ImplPortList { 
	...
	results { ap_memory {  { results_address0 mem_address 1 11 }  { results_ce0 mem_ce 1 1 }  { results_q0 mem_dout 0 4 } } }
}
