...
eval "cg_default_interface_gen_dc { \
    id 7 \
    name num_training_out \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_num_training_out \
    op interface \
    ports { num_training_out_din { O 32 vector } num_training_out_full_n { I 1 bit } num_training_out_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_num_test_out1 \
    op interface \
    ports { num_test_out1_din { O 32 vector } num_test_out1_full_n { I 1 bit } num_test_out1_write { O 1 bit } } \
} "
}
