set moduleName DigitRec_entry28
set isTopModule 0
...
set C_modelName {DigitRec.entry28}
set C_modelType { void 0 }
set C_modelArgList {
	{ num_training int 32 regular {fifo 0}  }
	{ num_test int 32 regular {fifo 0}  }
	{ num_training_out int 32 regular {fifo 1}  }
	{ num_test_out int 32 regular {fifo 1}  }
	{ num_test_out1 int 32 regular {fifo 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "num_training", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "num_training_out", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "num_test_out", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "num_test_out1", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ num_training_out_din sc_out sc_lv 32 signal 2 } 
	{ num_training_out_full_n sc_in sc_logic 1 signal 2 } 
	{ num_training_out_write sc_out sc_logic 1 signal 2 } 
	{ num_test_out_din sc_out sc_lv 32 signal 3 } 
	{ num_test_out_full_n sc_in sc_logic 1 signal 3 } 
	{ num_test_out_write sc_out sc_logic 1 signal 3 } 
	{ num_test_out1_din sc_out sc_lv 32 signal 4 } 
	{ num_test_out1_full_n sc_in sc_logic 1 signal 4 } 
	{ num_test_out1_write sc_out sc_logic 1 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "num_training_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "num_training_out", "role": "din" }} , 
 	{ "name": "num_training_out_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "num_training_out", "role": "full_n" }} , 
 	{ "name": "num_training_out_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "num_training_out", "role": "write" }} , 
 	...
 	{ "name": "num_test_out1_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "num_test_out1", "role": "din" }} , 
 	{ "name": "num_test_out1_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "num_test_out1", "role": "full_n" }} , 
 	{ "name": "num_test_out1_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "num_test_out1", "role": "write" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "num_training_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
			...
			{"Name" : "num_test_out1", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	...
	num_training_out { ap_fifo {  { num_training_out_din fifo_data 1 32 }  { num_training_out_full_n fifo_status 0 1 }  { num_training_out_write fifo_update 1 1 } } }
	...
	num_test_out1 { ap_fifo {  { num_test_out1_din fifo_data 1 32 }  { num_test_out1_full_n fifo_status 0 1 }  { num_test_out1_write fifo_update 1 1 } } }
}
