...
void DigitRec_trainingg8j::proc_tptr() {
    if (reset.read() == SC_LOGIC_1) {
        tptr.write(0);
...
void DigitRec_trainingg8j::proc_count() {
    if (reset.read() == SC_LOGIC_1) {
        count.write(0);
...
void DigitRec_trainingg8j::proc_full_n() {
    if (reset.read() == SC_LOGIC_1) {
...
void DigitRec_trainingg8j::proc_empty_n() {
    if (reset.read() == SC_LOGIC_1) {
